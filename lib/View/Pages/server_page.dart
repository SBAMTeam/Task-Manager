...
class HomePage extends GetView<TaskController> {
  ...
  const HomePage({Key key, @required this.serverId}) : super(key: key);
  ...
  return Container(
    ...
    child: Obx(
      () {
            ...
            itemBuilder: (context, index) {
              ...
              if (details.length > 50) {
                detailsShort = (taskController
                    ...
                    .substring(0, details.length - (25 - details.length).abs());
              ...
              return CardBuilder(
                taskTitle: "${taskController.serverTasksList[index].taskName}",
        ...
        else if (taskController.serverTasksList.length == 0) {
          return Center(
            child: TextBuilder(
